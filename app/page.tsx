...
export default function Home() {
  const structuredData = {
    ...
    "@type": "WebSite",
    "name": "TradeMart",
    "description": "Global B2B marketplace connecting verified suppliers with buyers worldwide",
    "url": "https://trademart.app",
    "potentialAction": {
      "@type": "SearchAction",
      "target": "https://trademart.app/search?q={search_term_string}",
    ...
    "publisher": {
      ...
      "logo": {
        "@type": "ImageObject",
        "url": "https://trademart.app/logofinal.png"
      }
    },
    "mainEntity": {
      "@type": "Organization",
      "name": "TradeMart",
      "description": "Leading global B2B marketplace for connecting buyers and suppliers",
      "url": "https://trademart.app",
      "logo": "https://trademart.app/logofinal.png",
      "contactPoint": {
        "@type": "ContactPoint",
      ...
      "sameAs": [
        "https://twitter.com/trademart",
        "https://linkedin.com/company/trademart",
        "https://facebook.com/trademart"
      ],
      "address": {
        "@type": "PostalAddress",
        "addressCountry": "US"
    ...
    "offers": {
      "@type": "Offer",
      "description": "B2B marketplace services",
      "price": "0",
      "priceCurrency": "USD"
    }
  };
        ...
        <section className="relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto text-center relative">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
              The leading global B2B marketplace connecting buyers with verified suppliers worldwide.
